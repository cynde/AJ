@extends('master.app')
@section('title') Tambah Rekapan Training @endsection
@section('css')
<!-- Select2 -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/rekapanTraining">Rekapan Training</a></li>
              <li class="breadcrumb-item active">Tambah Rekapan Training</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambah Rekapan Training</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form">
